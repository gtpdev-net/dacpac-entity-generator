...
namespace DataManager.Infrastructure.Migrations
{
    ...
    [Migration("20260312122937_AddColumnNameSearchIndex")]
    partial class AddColumnNameSearchIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceColumn", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ColumnName"), new[] { "TableId" });
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceDatabase", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DatabaseName"), new[] { "ServerId" });
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceFunction", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("FunctionName"), new[] { "DatabaseId", "SchemaName" });
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceStoredProcedure", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProcedureName"), new[] { "DatabaseId", "SchemaName" });
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceTable", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TableName"), new[] { "DatabaseId", "SchemaName" });
            ...
            modelBuilder.Entity("DataManager.Core.Models.Entities.SourceView", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ViewName"), new[] { "DatabaseId", "SchemaName" });
