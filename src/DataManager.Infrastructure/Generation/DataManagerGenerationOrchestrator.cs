...
/// <summary>
/// Orchestrates entity generation sourced from DataManagerDb (via an
...
/// console pipeline.
/// </summary>
public class DataManagerGenerationOrchestrator
{
    ...
    /// </summary>
    /// <param name="dataSource">Configured data source (e.g. <c>DataManagerDbSchemaDataSource</c>).</param>
