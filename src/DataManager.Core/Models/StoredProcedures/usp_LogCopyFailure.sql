/*
   ...
   The following snippet needs to be added to the EF migration that creates the CopyActivityLog table to ensure the stored procedure is available for logging failures.

   protected override void Up(MigrationBuilder migrationBuilder)
    {
        var path = Path.Combine(AppContext.BaseDirectory, "Models/StoredProcedures/usp_LogCopyFailure.sql");
    ...
    {
        migrationBuilder.Sql("DROP PROCEDURE dbo.usp_LogCopyFailure");
    }
*/ 
